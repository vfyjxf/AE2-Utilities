...
public class Ae2uBlocks {
    ...
    @GameRegistry.ObjectHolder(AE2Utilities.MODID + ":" + BlockEnhancedInterface.BASE_BLOCK_NAME + 1)
    public static BlockEnhancedInterface BLOCK_ENHANCED_INTERFACE_TIER_1;
    @GameRegistry.ObjectHolder(AE2Utilities.MODID + ":" + BlockEnhancedInterface.BASE_BLOCK_NAME + 2)
    public static BlockEnhancedInterface BLOCK_ENHANCED_INTERFACE_TIER_2;
    @GameRegistry.ObjectHolder(AE2Utilities.MODID + ":" + BlockEnhancedInterface.BASE_BLOCK_NAME + 3)
