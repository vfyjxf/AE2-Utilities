...
public class PartEnhancedInterfaceTier2 extends PartEnhancedInterfaceBase {

    @PartModels
    public static ResourceLocation[] MODELS = new ResourceLocation[] {
            new ResourceLocation(AE2Utilities.MODID, "part/enhanced_interface_base_tier2"),
    ...
    @Reflected
    public PartEnhancedInterfaceTier2(ItemStack is) {
        super(is);
    }
    ...
    public ItemStack getItemStackRepresentation() {
        return new ItemStack(Ae2uItems.ITEM_PART_ENHANCED_INTERFACE_TIER_2);
    }
