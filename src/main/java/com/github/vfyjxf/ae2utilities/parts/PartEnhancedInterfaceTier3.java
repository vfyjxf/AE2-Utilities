...
public class PartEnhancedInterfaceTier3 extends PartEnhancedInterfaceBase {

    @PartModels
    public static ResourceLocation[] MODELS = new ResourceLocation[]{
            new ResourceLocation(AE2Utilities.MODID, "part/enhanced_interface_base_tier3"),
    ...
    @Reflected
    public PartEnhancedInterfaceTier3(ItemStack is) {
        super(is);
    }
    ...
    public ItemStack getItemStackRepresentation() {
        return new ItemStack(Ae2uItems.ITEM_PART_ENHANCED_INTERFACE_TIER_3);
    }
